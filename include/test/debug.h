...
#define IO_debug_init() \
    ...
    PORT_REG_OUT(BUTTON_PORT) |= BUTTON_S1_PIN | BUTTON_S2_PIN; \
    PORT_REG_REN(BUTTON_PORT) |= BUTTON_S1_PIN | BUTTON_S2_PIN; \
    PORT_REG_IES(BUTTON_PORT) |= BUTTON_S1_PIN | BUTTON_S2_PIN; \
    PORT_REG_IFG(BUTTON_PORT) &= ~(BUTTON_S1_PIN | BUTTON_S2_PIN); \
    PORT_REG_IE(BUTTON_PORT) |= BUTTON_S1_PIN | BUTTON_S2_PIN;
